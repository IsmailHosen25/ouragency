...
export default function Terms() {
  ...
  return (
    <div className="w-[100%] flex flex-col justify-center items-start">
        ...
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320"><path fill="#F3F3F6" fill-opacity="1" d="M0,320L48,314.7C96,309,192,299,288,293.3C384,288,480,288,576,250.7C672,213,768,139,864,144C960,149,1056,235,1152,256C1248,277,1344,235,1392,213.3L1440,192L1440,0L1392,0C1344,0,1248,0,1152,0C1056,0,960,0,864,0C768,0,672,0,576,0C480,0,384,0,288,0C192,0,96,0,48,0L0,0Z"></path></svg>
        </div>
        <div className="w-[85%] relative z-[100] pt-[20px] md:pt-[25px] lg:pt-[80px]">
          <div>
            <h2 className="text-[#18B898] text-[20px]">Our Agency</h2>
            <h1 className="text-[25px] text-[#FF4935]">Terms of Services</h1>
          </div>
          <div className="pt-[30px] flex flex-col justify-start items-start gap-[25px] md:pt-[45px]">
            ...
            <div>
              <h2 className="text-[#0A1D56] text-[30px] font-[500] pb-[5px]">Estimates & Contracts</h2>
              <div className="flex flex-col justify-start items-start gap-[10px]">
                <p>
            ...
            <div>
              <h2 className="text-[#0A1D56] text-[30px] font-[500] pb-[5px]">Non-Disclosure</h2>
              <div className="flex flex-col justify-start items-start gap-[10px]">
                <p>
            ...
            <div>
              <h2 className="text-[#0A1D56] text-[30px] font-[500] pb-[5px]">Client</h2>
              <div className="flex flex-col justify-start items-start gap-[10px]">
                <p>
            ...
            <div>
              <h2 className="text-[#0A1D56] text-[30px] font-[500] pb-[5px]">Variations</h2>
              <div className="flex flex-col justify-start items-start gap-[10px]">
                <p>
                ...
                <p>Our website development phase is flexible and allows certain variations to the original specification. However any major deviation from the specification will be charged as per the variations.</p>
              </div>
            </div>
            <div>
              <h2 className="text-[#0A1D56] text-[30px] font-[500] pb-[5px]">Fess Deposits</h2>
              <div className="flex flex-col justify-start items-start gap-[10px]">
                <p>
                ...
                <p>The 50% deposit of advance paid is NON refundable as we book the domain & hosting on customer behalf. (We collect 50% payment after booking the domain & hosting)</p>
              </div>
            </div>
            <div>
              <h2 className="text-[#0A1D56] text-[30px] font-[500] pb-[5px]">Deliverables</h2>
              <div className="flex flex-col justify-start items-start gap-[10px]">
                <p>
            ...
            <div>
              <h2 className="text-[#0A1D56] text-[30px] font-[500] pb-[5px]">Payment</h2>
              <div className="flex flex-col justify-start items-start gap-[10px]">
                <p>
            ...
            <div>
              <h2 className="text-[#0A1D56] text-[30px] font-[500] pb-[5px]">E-commers Plan</h2>
              <div className="flex flex-col justify-start items-start gap-[10px]">
                <p>
            ...
            <div>
              <h2 className="text-[#0A1D56] text-[30px] font-[500] pb-[5px]">Policy updates</h2>
              <div className="flex flex-col justify-start items-start gap-[10px]">
                <p>
