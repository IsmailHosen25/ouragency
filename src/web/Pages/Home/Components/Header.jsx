  ...
  return (
    <div className="min-w-[100%] min-h-[100vh] relative flex justify-end items-center">
      <div className="w-[94%] min-h-[90vh] relative z-[200] flex flex-col justify-start items-start gap-[30px] md:w-[95%] lg:w-[97%]">
        ...
        <div className="w-[100%] h-[80vh] flex flex-col gap-[10px] justify-center items-center sm:gap-[65px] md:gap-[30px] lg:pl-[30px] lg:gap-[10px]">
          <div className="w-[100%] flex flex-wrap justify-start items-center">
            ...
            <div className="hidden justify-center items-center relative left-[32%] top-[30%]  lg:flex lg:left-0 lg:top-[0%] lg:ml-[5px]">
              <img
          ...
          <div className="w-[100%] flex justify-start items-center">
            {/* <div className="w-[100%] flex justify-start items-center gap-[3px] text-[20px] cursor-pointer sm:w-[40%] hover:text-[#86B6F6] duration-[0.3s]">
              View Our servies <BsBoxArrowInDown className="text-[#86A7FC]" />
            </div> */}
      ...
      <div className="absolute top-[45%] right-[12%] lg:top-[55%] xl:top-[35%]">
          <img  className="w-[80px] h-[80px]" src={airballon}/>
      </div>
      <div className="absolute top-[20%] left-[110px]">
